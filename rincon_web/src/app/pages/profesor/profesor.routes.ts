...
import { ActasHistorialProfesorComponent } from './actas-historial/actas-historial.component';
...
export const PROFESOR_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'reuniones-de-equipo/actas/historial', component: ActasHistorialProfesorComponent },
