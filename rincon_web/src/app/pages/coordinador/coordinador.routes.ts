...
import { ActasAsistenciaComponent } from '../profesor/actas-asistencia/actas-asistencia.component';
...
export const COORDINADOR_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'grupos-participantes', component: GruposParticipantesComponent },
