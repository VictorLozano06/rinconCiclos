...
CREATE TABLE cicloRecurso (
  ...
  CONSTRAINT fk_ciclo_recurso_ciclo FOREIGN KEY (idCiclo) REFERENCES cicloFormativo(idCiclo) ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT fk_ciclo_recurso_recurso FOREIGN KEY (idCategoria, numRecurso) REFERENCES recurso(idCategoria, numRecurso) ON UPDATE CASCADE ON DELETE CASCADE
);
